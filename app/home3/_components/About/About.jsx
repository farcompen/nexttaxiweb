...
const About = () => {
  return (
    <section className="max-w-[1400px] mx-auto px-container">
      <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 pb-24 md:pb-section lg:items-center">
        <div className="relative isolate">
          <Image
            ...
            src="/home3/about/about.png"
            alt="about"
          />
          <div className="absolute inset-0 items-end justify-end  pt-section flex ">
        ...
        <div>
          ...
          >
            If transportation technology was moving along as
          </h2>
          ...
          <div className="flex items-center gap-7">
            <Button className="w-full text-nowrap sm:w-[180px]">
              Contact Us
            </Button>
          </div>
        </div>
