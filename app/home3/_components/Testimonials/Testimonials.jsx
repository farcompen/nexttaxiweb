...
const Testimonials = () => {
  ...
  return (
    <section>
      <div className="max-w-container pt-24 md:pt-section px-container mx-auto">
        <SectionHeading label="OUR TESTIMONIAL">
          CLIENTS FEEDBACK
        </SectionHeading>

        <div ref={emblaRef} className="overflow-hidden  pt-16  pb-10">
          <div className="flex gap-5 ">
            {testimonialsData.map((review) => (
              <div
                ...
                key={review.id}
              >
                <article className="min-h-[282px] relative isolate rounded-tl-[90px] bg-dark-green px-8 pb-9 pt-24">
                  <div className=" left-28 h-[67px] bg-yellow absolute right-0 top-0 flex items-center">
                    <div className="relative isolate">
                      <div className="size-14 rounded-full grid place-content-center z-10 -translate-y-[90%] -translate-x-[140%] text-dark-green shrink-0 bg-white absolute left-0 bottom-0 text-2xl">
                        <LuQuote />
                      </div>
                      <Image
                        width={126}
                  ...
                  <div>
                    <p className="text-white text-center sm:text-start font-roboto mb-6">
                      {review.quote}
                    </p>
