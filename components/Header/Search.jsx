      ...
      <div className="fixed isolate inset-0 z-[9999]">
        ...
        <FocusLock disabled={!isSearchOpen} returnFocus={true}>
          <motion.dev
            ...
            className="relative will-change-transform px-4 flex items-center h-[90px] z-10 bg-light-dark gap-5 bg-dark-green"
          >
            <form
              onSubmit={(e) => {
                e.preventDefault();
              ...
              className="flex bg-yellow  rounded-2xl h-11 bg-blue  w-full "
            >
              <input
                placeholder="Search"
                className="flex-1   text-black placeholder:text-black text-sm px-5 h-11 focus-visible:outline-none bg-transparent"
                type="search"
              />
            </form>
